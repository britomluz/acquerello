...
public class AcquerelloApplication {
	...
	public CommandLineRunner initData(UserRepository userRepository, OrderRepository orderRepository, OrderDetailsRepository orderDetailsRepository, ProductRepository productRepository,
		...
		return (args) -> {
			...
			ProductCategory productCategory24 = new ProductCategory(product17, category1);
			...
			ProductCategory productCategory30 = new ProductCategory(product22, category9);
			productCategoryRepository.save(productCategory30);
			...
			ProductCategory productCategory33 = new ProductCategory(product24, category7);
			productCategoryRepository.save(productCategory33);
			...
			ProductCategory productCategory35 = new ProductCategory(product25, category7);
			productCategoryRepository.save(productCategory35);
			...
			ProductCategory productCategory42 = new ProductCategory(product31, category8);
			...
			ProductCategory productCategory44 = new ProductCategory(product32, category8);
