!(function (t, e) {
  ...
  M.on(
    ...
    M.on(window, "load.bs.carousel.data-api", function () {
      for (
        var t = Q.find('[data-ride="carousel"]'), e = 0, n = t.length;
        e < n;
        e++
      )
  ...
  var G = "collapse",
    ...
    J = (function () {
      function t(t, e) {
        ...
        for (
          var n = Q.find('[data-toggle="collapse"]'), i = 0, o = n.length;
          i < o;
          i++
        ) {
          var r = n[i],
      ...
      return (
        ...
        (i.show = function () {
          ...
          if (
            ...
            this._parent &&
              0 ===
                (n = Q.find(".show, .collapsing", this._parent).filter(
                  function (t) {
  ...
  function dt(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return "BODY" === (a = (s = l).nodeName) ||
        ("HTML" !== a && ut(s.firstElementChild) !== s)
        ? ut(l)
        : l;
    var c = ht(t);
  ...
  function Qt(t, e, n, i) {
    (n.updateBound = i),
      Ut(t).addEventListener("resize", n.updateBound, { passive: !0 });
    var o = st(t);
    return (
      (function t(e, n, i, o) {
    ...
    oe = (function () {
      function t(e, n) {
        ...
        bt(this, t),
          ...
          Object.keys(Et({}, t.Defaults.modifiers, o.modifiers)).forEach(
            function (e) {
      ...
      return (
        ...
        (i.show = function () {
          if (
            ...
            if (
              !M.trigger(this._element, "show.bs.dropdown", n).defaultPrevented
            ) {
              if (!this._inNavbar) {
                if (void 0 === oe)
                  throw new TypeError(
        ...
        (i._getPlacement = function () {
          ...
          return (
            t.classList.contains("dropup")
              ? (e = this._menu.classList.contains("dropdown-menu-right")
                  ? "top-end"
                  : "top-start")
        ...
        (t.clearMenus = function (e) {
          if (!e || (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)))
            for (
              var n = Q.find('[data-toggle="dropdown"]'), i = 0, o = n.length;
              i < o;
              i++
            ) {
      ...
      return (
        ...
        (i._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            Q.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
              function (e) {
        ...
        (i._resetScrollbar = function () {
          Q.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
            function (t) {
              ...
              void 0 !== e &&
                (U.removeDataAttribute(t, "padding-right"),
            ...
            Q.find(".sticky-top").forEach(function (t) {
              ...
              void 0 !== e &&
                (U.removeDataAttribute(t, "margin-right"),
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === de.indexOf(n) ||
                  Boolean(t.nodeValue.match(pe) || t.nodeValue.match(ge))
                );
              for (
      ...
      return (
        ...
        (i.hide = function () {
          ...
          if (this._popper) {
            ...
            if (
              !M.trigger(this.element, this.constructor.Event.HIDE)
                .defaultPrevented
            ) {
              var i;
              if (
        ...
        (o.jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new o(this, n)), y(this, "bs.popover", e)),
              "string" == typeof t)
            ) {
              if (void 0 === e[t])
    ...
    Pe = (function () {
      ...
      return (
        ...
        (i._getConfig = function (t) {
          if (
            "string" !=
              typeof (t = n({}, Ie, "object" == typeof t && t ? t : {}))
                .target &&
            u(t.target)
          ) {
            var e = t.target.id;
